...
import tech.octopusdragon.pokemontypegame.game.Game;
import tech.octopusdragon.pokemontypegame.game.Pokemon;
import tech.octopusdragon.pokemontypegame.game.PokemonGame;
import tech.octopusdragon.pokemontypegame.game.Type;
import tech.octopusdragon.pokemontypegame.game.TypeGame;
...
public class PokemonTypeGameApplication extends Application {
	...
	public final static String TYPE_IMAGES_DIR = "/img/type/";
	public final static String POKEMON_IMAGES_DIR = "/img/pkmn/";
	public final static String HELP_IMAGE_PATH = "/img/help.png";
	public final static String FAST_FORWARD_IMAGE_PATH = "/img/fast_forward.png";
	public final static String MUTE_IMAGE_PATH = "/img/mute.png";
	public final static String UNMUTE_IMAGE_PATH = "/img/unmute.png";
	public final static String ICON_PATH = "/img/icon.png";
	
	public final static String MENU_FXML_PATH = "/fxml/Menu.fxml";
	public final static String GAME_SCREEN_FXML_PATH = "/fxml/GameScreen.fxml";
	public final static String INSTRUCTIONS_FXML_PATH = "/fxml/Instructions.fxml";
	
	private final static String SONG_DIR = "/audio/music/";
	private final static String PRESS_BUTTON_SOUND_DIR = "/audio/press_button.mp3";
	
	public final static String SONG_LIST_PATH = "/song_list.txt";
	public final static String HOW_TO_PLAY_PATH = "/how_to_play.txt";
	private final static String CSS_PATH = "/styles.css";
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.getIcons().add(new Image(PokemonTypeGameApplication.class.getResourceAsStream(ICON_PATH)));
		...
		scene.getStylesheets().add(PokemonTypeGameApplication.class.getResource(CSS_PATH).toExternalForm());
	...
	private static void newShuffleList() {
		...
		InputStream inputStream = PokemonTypeGameApplication.class.getResourceAsStream(SONG_LIST_PATH);
