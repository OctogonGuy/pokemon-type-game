package tech.octopusdragon.pokemontypegame.game;
...
public class Pokemon {
	...
	// --- Static constants ---
	private static final String POKEMON_LIST_PATH = "/pokemon.csv";
	...
	private static Map<Integer, List<Pokemon>> readPokemonList() {
		...
		BufferedReader inputStream = new BufferedReader(
				...
				Pokemon.class.getResourceAsStream(POKEMON_LIST_PATH)));
