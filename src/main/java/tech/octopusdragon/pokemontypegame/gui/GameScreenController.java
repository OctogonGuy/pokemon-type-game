...
import tech.octopusdragon.pokemontypegame.PokemonTypeGameApplication;
import tech.octopusdragon.pokemontypegame.game.GameState;
...
public class GameScreenController {	// USE GRIDPANE- IT HAS PERCENT-WIDTH PERCENT-HEIGHT PROPERTIES DEPENDING ON IF ROW OR COLUMN
	...
	private void updateScene() {
		...
		case MEDIUM:
			...
			defendingPokemonType1ImageView.setImage(new Image(GameScreenController.class.getResourceAsStream(PokemonTypeGameApplication.TYPE_IMAGES_DIR + defendingPokemonTypes[0].getImageFilename())));
			if (defendingPokemonTypes.length == 2) {
				defendingPokemonType2ImageView.setImage(new Image(GameScreenController.class.getResourceAsStream(PokemonTypeGameApplication.TYPE_IMAGES_DIR + defendingPokemonTypes[1].getImageFilename())));
		...
		defendingImageView.setImage(new Image(GameScreenController.class.getResourceAsStream(PokemonTypeGameApplication.defendingImagePath())));
